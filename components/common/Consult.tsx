...
export function Channels() {
  ...
  return (
    <ul className="channels">
      ...
      <li><a href={t.kakao_openchat} target="_blank" rel="noopener noreferrer"><span><b>TNS 오픈채팅</b><small>중국 국제학교·청도대원 입학 질문</small></span><span aria-hidden="true">→</span></a></li>
