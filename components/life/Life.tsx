...
/** 기숙사 페이지에서 확인할 생활관리 세부 규정 */
export const OTHER_CARE: Array<[string, string]> = [
  ['기숙사 출입', '수업·방과후 일과 중에는 기숙사에 들어갈 수 없고, 기숙사 안의 노트북 사용도 학업 목적 허가가 필요합니다.'],
  ['세탁', '물세탁 의류는 학교 무료 세탁. 속옷·양말은 직접, 드라이클리닝은 주 1회 외부 업체.'],
  ['건강', '수업 중에는 보건실, 야간에는 사감이 응급조치와 병원 동행을 지원합니다. 재학생 전원 단체상해보험(연 300위안)에 가입합니다.'],
  ['학부모 소통', 'Thinkwave로 성적·과제·출결을 확인하고, 담임·기숙사 WeChat을 통해 생활 상황을 공유합니다.'],
];
