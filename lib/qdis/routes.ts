...
export const ROUTES: RouteMeta[] = [
  ...
  {path: '/boarding', key: 'boarding', section: 'life', crumb: '기숙사·학생관리', title: '기숙사·학생관리 | 청도대원학교 중국 보딩스쿨', description: 'G6–G8 선택기숙, G9–G12 의무기숙. 4인 1실, 남녀 사감, 야간 Study Hall, 휴대전화·외출외박·건강 관리와 Thinkwave·WeChat 학부모 소통까지 안내합니다.'},
  {path: '/daily-life', key: 'daily', section: 'life', crumb: '하루 일과·학교생활', title: '하루 일과와 학교생활 | 청도대원학교 A Day at QDIS', description: '기상부터 수업, Q&A 세션, 방과후, 간식, Study Hall까지 청도대원학교의 실제 하루. 주말 Project Creativity와 동아리, Sports, WSC·MUN 등 학생 활동도 소개합니다.'},
  ...
  {path: '/admissions', key: 'admissions', section: 'admissions', crumb: '입학조건·절차', title: '입학안내 | 청도대원학교 2026–27 조건·편입·전형·비자', description: '2026–27 청도대원학교 모집학급, 지원 자격, 편입·학년배정, 영어 지필·인터뷰, 제출서류, 학생비자(X1)와 거류증까지 단계별로 안내합니다.'},
