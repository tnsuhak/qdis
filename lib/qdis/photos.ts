...
export const PHOTOS: Record<string, Photo> = {
  ...
  seminar: {id: 'seminar', src: '/images/brochure/seminar.jpg', alt: '강당에서 대학 입학설명회를 듣는 학생들', credit: '청도대원학교 2026 브로셔', width: 234, height: 135, label: '대학 입학설명회', sub: 'University Visit', temporary: true},
