        ...
        <div className="wrap">
          <div className="split">
            <div className="sticky-col">
              ...
              <p className="lede" style={{marginTop: 18}}>3년 특례는 모집 정원의 약 2% 안에서 선발하는 만큼 본인의 공인 성적이 중요합니다. 청도대원 졸업생은 서울대·연세대·고려대·KAIST와 의과대학에 합격해 왔습니다.</p>
            ...
            <div className="prose">
              ...
              <p>서류+면접, 서류+필답, 필답+면접, 논술+면접 등 대학·계열마다 다릅니다. 일부 대학은 2025학년도 후기부터 자기소개서를 다시 요구하기 시작했고, 2027학년도부터 공식 부활이 예정되어 있어 미리 대비해야 합니다.</p>
              <h3>해외고 졸업자 수시</h3>
